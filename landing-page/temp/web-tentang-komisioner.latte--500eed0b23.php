...
/** source: /home/sukroncrb2025/Project/php/abiesoft/vendor/abiesoft/Http/../../../templates/web/tentang/komisioner.latte */
final class Template_500eed0b23 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/php/abiesoft/vendor/abiesoft/Http/../../../templates/web/tentang/komisioner.latte';
    ...
    <div class="container konten page">
        ...
        <div class="profile">
            <div class="grid grid-cols-3 grid-rows-1 gap-8 py-8">
                <div class="button-nama border-r-1 border-r-gray-200">
                ...
                <div class="col-start-2 col-span-2">
                    <div class="detail-info">
                        <div class="flex justify-start items-center gap-6 mb-8">
                            <div class="w-[130px] h-[150px] rounded-md overflow-hidden">
