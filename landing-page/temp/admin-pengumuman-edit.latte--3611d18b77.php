...
/** source: /home/sukroncrb2025/Project/kompolnas/vendor/abiesoft/Http/../../../templates/admin/pengumuman/edit.latte */
final class Template_3611d18b77 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/vendor/abiesoft/Http/../../../templates/admin/pengumuman/edit.latte';
...
';
    ...
    <div class="body-wrapper">
            ...
            <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-9">
                            <h4 class="fw-semibold mb-8">Edit Pengumuman</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="judul" name="judul" data-label="Judul" placeholder="Judul pengumuman" value="';
		...
		echo '"/>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                        <textarea class="form-control" style=\'height: 80px;\' id="keterangan" name="keterangan" data-label="Keterangan pengumuman" placeholder="Potongan pengumuman">';
		...
		echo '</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                        <select type="text" class="form-control" id="model" name="model" data-label="Model" placeholder="Model">
                                            <option value="';
		echo LR\Filters::escapeHtmlAttr($model) /* line 66 */;
		echo '">';
		echo LR\Filters::escapeHtmlText($model) /* line 66 */;
		echo '</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                        <input type="date" class="form-control" id="expire" name="expire" data-label="Tanggal expire" placeholder="Tanggal expire" value="';
		echo LR\Filters::escapeHtmlAttr($expire) /* line 74 */;
		echo '"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="link" name="link" data-label="Link" placeholder="Link" value="';
		echo LR\Filters::escapeHtmlAttr($link) /* line 80 */;
		echo '" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                        <select type="text" class="form-control" id="status" name="status" data-label="Status" placeholder="Status">
                                            <option value="';
		echo LR\Filters::escapeHtmlAttr($status) /* line 87 */;
		echo '">';
		echo LR\Filters::escapeHtmlText($status) /* line 87 */;
		echo '</option>
                    ...
                    <div class="col-lg-4">
                        <div class="offcanvas-md offcanvas-end overflow-auto" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-7">Banner Pengumuman</h4>
                                    <div id=\'errorupload\'></div>
                                    <div style=\'position: relative; width: 100%; min-height: 330px; padding: 10px; border-radius: 5px; border: 2px dashed #bdbdbd; background: #eee;\'>
                                        ...
                                        <input type=\'hidden\' id=\'banner\' name=\'banner\' data-label="Banner" value=\'';
		echo LR\Filters::escapeHtmlAttr($banner) /* line 106 */;
		echo '\'>
                                        <img id="preview" src=\'';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 107 */;
		echo LR\Filters::escapeHtmlAttr($banner) /* line 107 */;
		...
		echo LR\Filters::escapeHtmlAttr($id) /* line 130 */;
		echo '\'>
...
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 148 */;
...
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 151 */;
		echo '/assets/admin/js/forms/repeater-init.js"></script>
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 152 */;
		echo 'assets/admin/libs/sweetalert2/dist/sweetalert2.min.js"></script>
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 153 */;
