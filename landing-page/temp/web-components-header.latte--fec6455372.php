...
/** source: /home/sukroncrb2025/Project/php/abiesoft/templates/web/components/header.latte */
final class Template_fec6455372 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/php/abiesoft/templates/web/components/header.latte';
		...
		echo 'assets/admin/images/custom-apps/img/Logo_Kompolnas.png\'><span>KOMPOLNAS</span></span>
            ...
            <div class="relative w-full">
                <div class="w-[90%] mx-auto relative">
                    ...
                    <svg class="
                        absolute w-6 stroke-gray-300 left-auto top-[-30px] right-0  
                        2xl:left-2 2xl:top-2 
                        xl:left-2 xl:top-2
                        lg:left-2 lg:top-2 
                        md:left-auto md:top-[-30px] md:right-0
                        sm-left-auto sm-top-[-30px] sm:right-0
            ...
            <div class="
                ...
                <div class="w-full flex justify-center items-center gap-4">
                    ...
                    <div>
                        <div class="text-sm">';
		echo LR\Filters::escapeHtmlText($tanggaldanharisimple) /* line 48 */;
		echo '</div>
    ...
    <div class="container">
		...
		echo '\'>
                    ...
                    <li>
                        ...
                        <ul>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 74 */;
		...
		echo 'tentang-kompolnas/arti-logo-dan-lambang\'>Arti logo dan lambang</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 76 */;
		echo 'tentang-kompolnas/visi-dan-misi\'><a href=\'';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 76 */;
		echo 'tentang-kompolnas/visi-dan-misi\'>Visi dan Misi</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 77 */;
		echo 'tentang-kompolnas/tupoksi\'><a href=\'';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 77 */;
		echo 'tentang-kompolnas/tupoksi\'>Tupoksi</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 78 */;
		echo 'tentang-kompolnas/struktur-organisasi\'><a href=\'';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 78 */;
		echo 'tentang-kompolnas/struktur-organisasi\'>Struktur Organisasi</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 79 */;
		echo 'tentang-kompolnas/komisioner\'><a href=\'';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 79 */;
		...
		echo 'regulasi/tap-mpr-ri\'>TAP MPR RI</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 107 */;
		...
		echo 'regulasi/undang-undang\'>Undang-undang</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 108 */;
		...
		echo 'regulasi/peraturan-kompolnas\'>Peraturan Kompolnas</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 110 */;
		echo 'regulasi/peraturan-polri\'><a href=\'';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 110 */;
		echo 'regulasi/peraturan-polri\'>Peraturan Polri</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 111 */;
		echo 'regulasi/peraturan-kapolri\'><a href=\'';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 111 */;
		echo 'regulasi/peraturan-kapolri\'>Peraturan Kapolri</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 112 */;
		...
		echo 'regulasi/surat-edaran\'>Surat Edaran</a></li>
                            <li onClick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 113 */;
		echo 'regulasi/peraturan-menko\'><a href=\'';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 113 */;
		echo 'regulasi/peraturan-menko\'>Permenko</a></li>
                        </ul>
                    </li>
                    <li onclick="window.location.href=this.dataset.link" data-link=\'';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 116 */;
		echo 'hubungi-kami\'>
                ...
                <div class="flex justify-end items-center gap-4">
                    <button 
                        ...
                        data-link=\'';
		echo LR\Filters::escapeHtmlAttr($linkpengaduan) /* line 124 */;
		echo '\'
                        type="button" 
                        class="
                            mt-2
                    ...
                    <button
                        onclick="window.location.href=this.dataset.link" 
                        data-link=\'';
		echo LR\Filters::escapeHtmlAttr($linkppid) /* line 165 */;
		echo '\' 
                        type="button" 
