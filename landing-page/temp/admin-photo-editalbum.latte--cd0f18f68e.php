...
/** source: /home/sukroncrb2025/Project/kompolnas/vendor/abiesoft/Http/../../../templates/admin/photo/editalbum.latte */
final class Template_cd0f18f68e extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/vendor/abiesoft/Http/../../../templates/admin/photo/editalbum.latte';
...
';
    ...
    <div class="body-wrapper">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" id="judul" name="judul" data-label="Judul Album" value="';
		...
		echo '">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                        <textarea class="form-control" style=\'height: 100px;\' id="keterangan" name="keterangan" data-label="Keterangan Album">';
		...
		echo '</textarea>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select type="text" class="form-control" id="kategori" name="kategori" data-label="Kategori" placeholder="Kategori">
                                            <option value="';
		echo LR\Filters::escapeHtmlAttr($kategori) /* line 66 */;
		echo '">';
		echo LR\Filters::escapeHtmlText($kategori) /* line 66 */;
		echo '</option>
		...
		echo LR\Filters::escapeHtmlAttr($cover) /* line 88 */;
		echo '">
                                        <img id="preview" src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 89 */;
		echo LR\Filters::escapeHtmlAttr($cover) /* line 89 */;
		...
		echo LR\Filters::escapeHtmlAttr($id) /* line 112 */;
		echo '\'>
                                    <input type=\'hidden\' id=\'tipe\' name=\'tipe\' value=\'EDITALBUM\'>
