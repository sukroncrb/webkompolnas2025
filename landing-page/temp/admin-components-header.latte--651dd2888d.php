...
/** source: /home/sukroncrb2025/Project/php/abiesoft/templates/admin/components/header.latte */
final class Template_651dd2888d extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/php/abiesoft/templates/admin/components/header.latte';
    ...
    <nav class="navbar navbar-expand-lg p-0">
		...
		echo '" class="py-6 px-7 d-flex align-items-center dropdown-item">
                                    <span class="me-3">
                                        <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($sesi['photo'])) /* line 47 */;
		echo '" alt="user" class="rounded-circle" width="48" height="48" />
                                    </span>
                                    <div class="w-100">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($sesi['photo'])) /* line 64 */;
		echo '" class="rounded-circle" width="35" height="35" alt="modernize-img" />
                        ...
                        <div class="profile-dropdown position-relative" data-simplebar>
                            ...
                            <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($sesi['photo'])) /* line 74 */;
		echo '" class="rounded-circle" width="80" height="80" alt="modernize-img" />
                                <div class="ms-3">
                                    <h5 class="mb-1 fs-3" id="namauser">';
		echo LR\Filters::escapeHtmlText($sesi['nama']) /* line 76 */;
		echo '</h5>
                                    <span class="mb-1 d-block">';
		echo LR\Filters::escapeHtmlText($sesi['namagrup']) /* line 77 */;
		echo '</span>
                                    <p class="mb-0 d-flex align-items-center gap-2">
                                        <i class="ti ti-mail fs-4"></i> ';
		echo LR\Filters::escapeHtmlText($sesi['email']) /* line 79 */;
		echo '
                                    </p>
                                </div>
                            </div>
		...
		echo LR\Filters::escapeHtmlAttr($sesi['id']) /* line 84 */;
		...
		echo '/profile/detail/?uid=';
		echo LR\Filters::escapeHtmlAttr($sesi['id']) /* line 93 */;
		echo '&p=tugas" class="py-8 px-7 d-flex align-items-center">
                                    <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                                        <img src="';
