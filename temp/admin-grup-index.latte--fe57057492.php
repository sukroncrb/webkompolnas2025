...
/** source: /home/sukroncrb2025/Project/php/abiesoft/vendor/abiesoft/Http/../../../templates/admin/grup/index.latte */
final class Template_fe57057492 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/php/abiesoft/vendor/abiesoft/Http/../../../templates/admin/grup/index.latte';
	...
	public function main(array $ʟ_args): void
	{
		...
		$this->renderBlock('js', get_defined_vars()) /* line 72 */;
	}
...
';
    ...
    <div class=\'container-fluid\'>
		...
		echo '/assets/admin/images/custom-apps/icons/grup-icon.png" alt="modernize-img" class="img-fluid mb-n4" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class=\'row\'>
            <div class=\'col-12\'>
                ...
                <!-- start Add Row -->
                    <div class="card">
                    <div class="card-body">
                        <button class="btn btn-primary mb-4" onClick=\'window.location.href=this.dataset.link\' data-link="';
		echo LR\Filters::escapeHtmlAttr($baseurl) /* line 36 */;
		echo LR\Filters::escapeHtmlAttr($prefix_dashboard) /* line 36 */;
		echo '/users/add">
                            <i class="ti ti-plus fs-4"></i> Buat Users
                        </button>
