...
/** source: /home/sukroncrb2025/Project/kompolnas/vendor/abiesoft/Http/../../../templates/admin/pengumuman/add.latte */
final class Template_ac014b30bd extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/vendor/abiesoft/Http/../../../templates/admin/pengumuman/add.latte';
            ...
            <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-9">
                            <h4 class="fw-semibold mb-8">Pengumuman Baru</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="judul" name="judul" data-label="Judul" placeholder="Judul pengumuman" />
                                        <label for="judul">Judul</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                        <textarea class="form-control" style=\'height: 80px;\' id="keterangan" name="keterangan" data-label="Keterangan pengumuman" placeholder="Potongan pengumuman"></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                        <input type="date" class="form-control" id="expire" name="expire" data-label="Tanggal expire" placeholder="Tanggal expire" />
                                        <label for="expire">Expire</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="link" name="link" data-label="Judul" placeholder="Link file" />
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div style=\'position: relative; width: 100%; min-height: 330px; padding: 10px; border-radius: 5px; border: 2px dashed #bdbdbd; background: #eee;\'>
                                        ...
                                        <input type=\'hidden\' id=\'banner\' name=\'banner\' data-label="Banner">
