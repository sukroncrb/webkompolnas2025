...
/** source: /home/sukroncrb2025/project/php/kompolnas/vendor/abiesoft/Http/../../../templates/admin/surat/add.latte */
final class Template_a161fd95e9 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/project/php/kompolnas/vendor/abiesoft/Http/../../../templates/admin/surat/add.latte';
	...
	public function main(array $ʟ_args): void
	{
		...
		$this->renderBlock('js', get_defined_vars()) /* line 285 */;
	}
        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Pengaduan Baru</h4>
                        <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 18 */;
		echo LR\Filters::escapeHtmlAttr($prefix_dashboard) /* line 18 */;
		echo '/surat">Surat</a>
                            </li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="alert bg-light-subtle" role="alert">
                            ...
                            <div>Setelah input selesai.</div>
                            <div>
                                Printout tanda terima yang untuk diberikan ke pengadu dan lembar informasi dokumen untuk diprint di lembar merah kemudian dokumen yang diinput diserahkan ke kasubbag penerimaan untuk diketahui Kasubbag penerimaan 
                                bahwa dokumen fisik ada dan selanjutnya akan di serahkan ke Kasubbag Data setelah diverifikasi diaplikasi lengkap/ belum lengkap oleh Kasubbag Penerimaan.
                            </div>
                        </div>
...
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 291 */;
		echo '/assets/admin/js/forms/select2.init.js"></script>
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 292 */;
		echo '/assets/admin/libs/jquery.repeater/jquery.repeater.min.js"></script>
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 293 */;
		echo '/assets/admin/libs/jquery-validation/dist/jquery.validate.min.js"></script>
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 294 */;
