...
/** source: /home/sukroncrb2025/Project/kompolnas/vendor/abiesoft/Http/../../../templates/admin/regulasi/edit.latte */
final class Template_5828ebe2e7 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/vendor/abiesoft/Http/../../../templates/admin/regulasi/edit.latte';
	...
	public function main(array $ʟ_args): void
	{
		...
		$this->renderBlock('js', get_defined_vars()) /* line 184 */;
	}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="judul" name="judul" data-label="Judul" placeholder="Judul regulasi" value="';
		echo LR\Filters::escapeHtmlAttr($judul) /* line 56 */;
		echo '" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                            <select type="text" class="form-control" id="bentuk" name="bentuk" data-label="Bentuk">
                                                <option value="';
		echo LR\Filters::escapeHtmlAttr($bentuk) /* line 63 */;
		echo '">';
		echo LR\Filters::escapeHtmlText($bentuk) /* line 63 */;
		echo '</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="pemerkarsa" name="pemerkarsa" data-label="Pemerkarsa" placeholder="Pemerkarsa" value="';
		echo LR\Filters::escapeHtmlAttr($pemerkarsa) /* line 78 */;
		echo '" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="nomor" name="nomor" data-label="Nomor" placeholder="Nomor" value="';
		echo LR\Filters::escapeHtmlAttr($nomor) /* line 84 */;
		echo '" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                            <textarea type="text" style=\'height: 80px;\' class="form-control" id="tentang" name="tentang" data-label="Tentang" placeholder="Tentang">';
		echo LR\Filters::escapeHtmlText($tentang) /* line 90 */;
		echo '</textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="pengundang" name="pengundang" data-label="Pengundang" placeholder="Pengundang" value="';
		echo LR\Filters::escapeHtmlAttr($pengundang) /* line 96 */;
		echo '" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="tempatpenetapan" name="tempatpenetapan" data-label="Tempat penetapan" placeholder="Tempat penetapan" value="';
		echo LR\Filters::escapeHtmlAttr($tempatpenetapan) /* line 106 */;
		echo '" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="date" class="form-control" id="tanggalpenetapan" name="tanggalpenetapan" data-label="Tanggal penetapan" placeholder="Tanggal penetapan" value="';
		echo LR\Filters::escapeHtmlAttr($tanggalpenetapan) /* line 112 */;
		echo '" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="penandatangan" name="penandatangan" data-label="Penandatangan" placeholder="Penandatangan" value="';
		echo LR\Filters::escapeHtmlAttr($penandatangan) /* line 118 */;
		echo '" />
                                    ...
                                    <div class="col-md-12 mb-7">
                                        <div class="form-floating mb-3">
                                            <select type="text" class="form-control" id="status" name="status" data-label="Status dokumen">
                                                <option value="';
		echo LR\Filters::escapeHtmlAttr($status) /* line 134 */;
		echo '">';
		echo LR\Filters::escapeHtmlText($status) /* line 134 */;
		echo '</option>
                                    ...
                                    <div style=\'position: relative; width: 100%; min-height: 320px; padding: 10px; border-radius: 5px; border: 2px dashed #bdbdbd; background: #eee;\'>
                                        ...
                                        <input type=\'hidden\' id=\'dokumen\' name=\'dokumen\' data-label="Dokumen" value="';
		echo LR\Filters::escapeHtmlAttr($dokumen) /* line 146 */;
		echo '">
                                        <img id="preview" src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 147 */;
		echo 'assets/admin/images/custom-apps/icons/pdf.png" style="width: 100%; display: block; position: relative; z-index: 1;">
