...
final class Template_faae83c1e5 extends Latte\Runtime\Template
{
    ...
    <div>
		...
		echo '/regulasi" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 144 */;
		echo LR\Filters::escapeHtmlAttr($prefix_dashboard) /* line 144 */;
		echo '/anggota" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 216 */;
		echo LR\Filters::escapeHtmlAttr($prefix_dashboard) /* line 216 */;
		...
		echo '/form/data/pengaduan" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        <li class="sidebar-item">
                            <a href="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 247 */;
		echo LR\Filters::escapeHtmlAttr($prefix_dashboard) /* line 247 */;
		...
		echo '/grup" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 265 */;
		echo LR\Filters::escapeHtmlAttr($prefix_dashboard) /* line 265 */;
        ...
        <div class="fixed-profile p-3 mx-4 mb-2 bg-secondary-subtle rounded mt-3 text-center">
            <span class="fs-2">';
		echo LR\Filters::escapeHtmlText($tanggaldanhari) /* line 280 */;
		echo '</span>
