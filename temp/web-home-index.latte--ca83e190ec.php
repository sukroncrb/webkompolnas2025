...
final class Template_ca83e190ec extends Latte\Runtime\Template
{
...
';
	...
	public function blockContent(array $ʟ_args): void
	{
		...
		echo '<section>
';
		$this->createTemplate('./section/carousel.latte', $this->params, 'include')->renderToContentType('html') /* line 37 */;
		$this->createTemplate('./section/quotes.latte', $this->params, 'include')->renderToContentType('html') /* line 38 */;
		$this->createTemplate('./section/shortcut_menu.latte', $this->params, 'include')->renderToContentType('html') /* line 39 */;
		$this->createTemplate('./section/kompolnas.latte', $this->params, 'include')->renderToContentType('html') /* line 40 */;
		$this->createTemplate('./section/youtube.latte', $this->params, 'include')->renderToContentType('html') /* line 41 */;
		$this->createTemplate('./section/polri.latte', $this->params, 'include')->renderToContentType('html') /* line 42 */;
		$this->createTemplate('./section/link.latte', $this->params, 'include')->renderToContentType('html') /* line 43 */;
		echo '</section>
<div class="banner-popup">
  <div class="popupclass" id="popup" onClick="setToHide()">
    <div class="card">
      <div class="card-body">
        <div style=\'text-align: right;\'></div>
        <div><img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 50 */;
		echo LR\Filters::escapeHtmlAttr($banner) /* line 50 */;
		echo '" style=\'width: 500px;\'></p>
      </div>
    </div>
  </div>
</div>
