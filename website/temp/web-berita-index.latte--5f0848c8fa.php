...
/** source: /home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/web/berita/index.latte */
final class Template_5f0848c8fa extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/web/berita/index.latte';
        ...
        for(let i=0; i< databerita.length; i++){
            if(i == (startfrom + 1) || i < (startfrom + jumlahitem)){
                ...
                <articles 
                    ...
                    data-link=\'`+baseurl+`berita/`+databerita[i].kategori.toLowerCase()+`/`+databerita[i].slug+`\'
                >
