...
/** source: /home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/web/home/index.latte */
final class Template_d6fea0c2c9 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/web/home/index.latte';
	...
	public function main(array $ʟ_args): void
	{
		...
		$this->renderBlock('content', get_defined_vars()) /* line 96 */;
...
';
	...
	public function blockContent(array $ʟ_args): void
	{
		...
		echo '<section>
';
		$this->createTemplate('./section/carousel.latte', $this->params, 'include')->renderToContentType('html') /* line 98 */;
		$this->createTemplate('./section/quotes.latte', $this->params, 'include')->renderToContentType('html') /* line 99 */;
		$this->createTemplate('./section/shortcut_menu.latte', $this->params, 'include')->renderToContentType('html') /* line 100 */;
		$this->createTemplate('./section/kompolnas.latte', $this->params, 'include')->renderToContentType('html') /* line 101 */;
		$this->createTemplate('./section/youtube.latte', $this->params, 'include')->renderToContentType('html') /* line 102 */;
		$this->createTemplate('./section/polri.latte', $this->params, 'include')->renderToContentType('html') /* line 103 */;
		$this->createTemplate('./section/link.latte', $this->params, 'include')->renderToContentType('html') /* line 104 */;
		echo '</section>
';
		if ($banner != '') /* line 106 */ {
			echo '<div class="banner-popup" style="margin: 50px;">
      ...
      <div class="card-body">
        ...
        <div style=\'min-width: 414px; min-height: 500px;\'>
          <img src="';
			...
			echo LR\Filters::escapeHtmlAttr($banner) /* line 119 */;
			echo '" class=\'img-banner\'>
          </p>
          <button class="btn-visit" onClick="setToHide(this.dataset.link)" data-link=\'';
			echo LR\Filters::escapeHtmlAttr($linkbanner) /* line 121 */;
			echo '\'>
