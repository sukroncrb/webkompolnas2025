...
/** source: /home/sukroncrb2025/Project/php/abiesoft/vendor/abiesoft/Http/../../../templates/admin/users/index.latte */
final class Template_479e822eb5 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/php/abiesoft/vendor/abiesoft/Http/../../../templates/admin/users/index.latte';
	...
	public function blockContent(array $ʟ_args): void
	{
		...
		echo 'assets/admin/images/breadcrumb/ChatBc.png" alt="modernize-img" class="img-fluid mb-n4" />
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 142 */;
		echo 'assets/admin/images/profile/user-2.jpg" alt="avatar" class="rounded-circle" width="35" />
                          <div class="ms-3">
		...
		echo 'assets/admin/images/profile/user-2.jpg" alt="avatar" class="rounded-circle" width="35" />
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 226 */;
		echo 'assets/admin/images/profile/user-3.jpg" alt="avatar" class="rounded-circle" width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
		...
		echo 'assets/admin/images/profile/user-4.jpg" alt="avatar" class="rounded-circle" width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 310 */;
		echo 'assets/admin/images/profile/user-5.jpg" alt="avatar" class="rounded-circle" width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 352 */;
		echo 'assets/admin/images/profile/user-12.jpg" alt="avatar" class="rounded-circle" width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 392 */;
		echo 'assets/admin/images/profile/user-2.jpg" alt="avatar" class="rounded-circle" width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 432 */;
		echo 'assets/admin/images/profile/user-3.jpg" alt="avatar" class="rounded-circle" width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
