...
/** source: /home/sukroncrb2025/Project/kompolnas/website/templates/admin/components/header.latte */
final class Template_92f2105d11 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/website/templates/admin/components/header.latte';
    ...
    <nav class="navbar navbar-expand-lg p-0">
		...
		echo '" class="rounded-circle" width="35" height="35" alt="modernize-img" />
                        ...
                        <div class="profile-dropdown position-relative" data-simplebar>
                            ...
                            <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                <div style=\'width: 80px; height: 80px; overflow:hidden; border-radius: 50%; margin: 0 auto;\'><img id="preview2" src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($sesi['photo'])) /* line 48 */;
		echo '" alt="modernize-img" style=\'width: 80px; height: 80px; object-fit: cover;\'></div>
                                <div class="ms-3">
                                    <h5 class="mb-1 fs-3" id="namauser">';
		echo LR\Filters::escapeHtmlText($sesi['nama']) /* line 51 */;
		echo '</h5>
                                    <span class="mb-1 d-block">';
		echo LR\Filters::escapeHtmlText($sesi['namagrup']) /* line 52 */;
		echo '</span>
                                    <p class="mb-0 d-flex align-items-center gap-2">
                                        <i class="ti ti-mail fs-4"></i> ';
		echo LR\Filters::escapeHtmlText($sesi['email']) /* line 54 */;
		echo '
                                    </p>
                                </div>
                            </div>
		...
		echo LR\Filters::escapeHtmlAttr($prefix_dashboard) /* line 59 */;
		echo '/profile/detail/?uid=';
		echo LR\Filters::escapeHtmlAttr($sesi['id']) /* line 59 */;
