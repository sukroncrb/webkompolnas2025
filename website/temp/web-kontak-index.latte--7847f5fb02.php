...
/** source: /home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/web/kontak/index.latte */
final class Template_7847f5fb02 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/web/kontak/index.latte';
    ...
    <div class="container konten page">
        ...
        <div class="grid grid-cols-3 grid-rows-1 gap-8 border-b-1 border-b-gray-200 pb-8">
            ...
            <div class="col-start-2 col-span-2">
                ...
                <div>';
		echo LR\Filters::escapeHtmlText($webinfo['alamat']) /* line 36 */;
		echo '</div>
        ...
        <div class="grid grid-cols-3 grid-rows-1 gap-8 border-b-1 border-b-gray-200 py-8">
            ...
            <div class="col-start-2 col-span-2">
                ';
		echo LR\Filters::escapeHtmlText($webinfo['notlp']) /* line 43 */;
		echo '/ ';
		echo LR\Filters::escapeHtmlText($webinfo['fax']) /* line 43 */;
		echo '
            </div>
        </div>
        <div class="grid grid-cols-3 grid-rows-1 gap-8 border-b-1 border-b-gray-200 py-8">
            ...
            <div class="col-start-2 col-span-2">
                <a href="mailto:';
		echo LR\Filters::escapeHtmlAttr($webinfo['email']) /* line 49 */;
		echo '">';
		echo LR\Filters::escapeHtmlText($webinfo['email']) /* line 49 */;
		echo '</a>
            </div>
        </div>
        <div class="grid grid-cols-3 grid-rows-1 gap-8 py-8">
            ...
            <div class="col-start-2 col-span-2">
                <a href="https://kompolnas.go.id">';
		echo LR\Filters::escapeHtmlText($baseurl) /* line 55 */;
		echo '</a>
            </div>
        </div>
    </div>
