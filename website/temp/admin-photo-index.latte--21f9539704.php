...
/** source: /home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/admin/photo/index.latte */
final class Template_21f9539704 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/admin/photo/index.latte';
...
';
	...
	<div class="container-fluid">
		...
		echo '">Home</a>
								...
								<li class="breadcrumb-item" aria-current="page">Album Photo</li>
							</ol>
						</nav>
					</div>
					<div class="col-3">
		...
		echo '/photo/album" id="btn-add-contact" class="btn btn-primary d-flex align-items-center">
							<i class="ti ti-plus text-white me-1 fs-5"></i> Buat Album </a>
					</div>
				</div>
			</div>
				...
				<div class="table-responsive">
					<table class="table search-table align-middle">
						<thead class="header-item">
							<th class="text-center w-[150px]">Cover</th>
							<th>Judul</th>
              <th class=\'text-center\'>Kategori</th>
							<th class="text-center">Opsi</th>
						</thead>
						<tbody id="daftaralbum"></tbody>
					</table>
					<div id="btnload">
...
async function getDataFromDB() {
    ...
    const url = baseurl + "api/photo/album";
    try {
                ...
                itemdata += `
                  <tr>
                    <td style=\'width: 150px; text-align: center;\'>
                      <div style=\'width: 150px; text-align: center;\'><img src=\'`+baseurl+semuadata[i].cover+`\' style=\'width: 100px;\'></div>
                    </td>
                    <td>
                      <div class=\'mb-2\'><strong>`+semuadata[i].judul+`</strong></div>
                      <div>`+semuadata[i].keterangan+`</div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div class="action-btn text-center" style=\'display: flex; justify-content: center; align-items: center; gap: 5px;\'>
                        <a href="`+baseurl+prefix+`/photo/album/`+semuadata[i].id+`/edit" class="text-dark hover:text-primary edit ms-2">
                          <i class="ti ti-edit fs-5"></i>
                        </a>
                        <a href="`+baseurl+prefix+`/photo/album/`+semuadata[i].id+`" class="text-dark hover:text-primary edit ms-2">
...
function doRemove(x) {
    ...
    fetch(baseurl + \'api/photo\', {
        ...
        if(result.code == "200"){
          Swal.fire({
            title: "Ok!",
            html: "Photo <strong class=\'text-danger\'>"+result.data.judul +"</strong> sudah dihapus.",
            icon: "success"
          });
