...
/** source: /home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/admin/form/pengaduan.latte */
final class Template_9736d83bfc extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/admin/form/pengaduan.latte';
				...
				<div class="row">
					<div class="col-md-4 col-xl-3">
						<form class="position-relative" id=\'formSearch\' name=\'formSearch\' onSubmit=\'return searchData()\'>
                            ...
                            <input type=\'hidden\' id=\'tabel\' name=\'tabel\' value=\'pengaduan\'>
			...
			<div class="card card-body" style="margin-left: -20px;">
				<div class="table-responsive">
					<table class="table search-table align-middle">
						...
						<tbody id="daftarpengaduan"></tbody>
					</table>
					<div id="btnload">
...
<script>
let semuadata = [];
const elementid = \'daftarpengaduan\';
const jumlahitem = 10;
let startfrom = 0;
...
async function getDataFromDB() {
    ...
    const url = baseurl + "api/form/pengaduan";
    try {
...
function getLoadData(x) {
    ...
    setTimeout(()=>{
        for(let i=0; i< semuadata.length; i++){
            let statuspengaduan = `<span class=\'badge text-bg-danger\'>Belum ditangani</span>`;
            ...
            if(i == (startfrom + 1) || i < (startfrom + jumlahitem)){
                itemdata += `
                  <tr>
                    ...
                    <td>
                      <div class=\'text-center\'>`+statuspengaduan+`</div>
                    </td>
                    <td>
                      <div class="action-btn text-center" style=\'display: flex; justify-content: center; align-items: center; gap: 5px;\'>
                        <a href="`+baseurl+prefix+`/pengaduan/`+semuadata[i].id+`/read" class="text-dark hover:text-primary edit ms-2">
...
function hps(x) {
  Swal.fire({
    title: "Konfirmasi",
    html: "Ingin menghapus pengaduan <strong class=\'text-danger\'>"+x[1] +"</strong> ?",
    icon: "warning",
...
function doRemove(x) {
    ...
    fetch(baseurl + \'api/form\', {
        ...
        if(result.code == "200"){
          Swal.fire({
            title: "Ok!",
            html: "Pengaduan <strong class=\'text-danger\'>"+result.data.nomor +"</strong> sudah dihapus.",
            icon: "success"
          });
