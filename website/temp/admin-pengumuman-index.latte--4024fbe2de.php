...
/** source: /home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/admin/pengumuman/index.latte */
final class Template_4024fbe2de extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/admin/pengumuman/index.latte';
...
';
	...
	<div class="container-fluid">
		<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
			<div class="card-body px-4 py-3">
				<div class="row align-items-center">
					<div class="col-9">
						<h4 class="fw-semibold mb-8">Semua pengumuman</h4>
		...
		echo '/pengumuman/add" id="btn-add-contact" class="btn btn-primary d-flex align-items-center">
							<i class="ti ti-plus text-white me-1 fs-5"></i> Buat pengumuman </a>
					</div>
				</div>
			</div>
				...
				<div class="table-responsive">
					<table class="table search-table align-middle">
						<thead class="header-item">
							<th class="text-center w-[150px]">Banner</th>
							<th>Judul</th>
              <th class=\'text-center\'>Expire</th>
              <th class=\'text-center\'>Status</th>
							<th class="text-center">Opsi</th>
						</thead>
						<tbody id="daftarpengumuman"></tbody>
					</table>
					<div id="btnload">
...
<script>
let semuadata = [];
const elementid = \'daftarpengumuman\';
const jumlahitem = 10;
let startfrom = 0;
...
async function getDataFromDB() {
    ...
    const url = baseurl + "api/pengumuman/tabel";
    try {
                ...
                itemdata += `
                  <tr>
                    <td style=\'width: 150px; text-align: center;\'>
                      <div style=\'width: 150px; text-align: center;\'><img src=\'`+baseurl+semuadata[i].banner+`\' style=\'width: 100px;\'></div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div class=\'text-center\'>`+semuadata[i].expire+`</div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div class="action-btn text-center" style=\'display: flex; justify-content: center; align-items: center; gap: 5px;\'>
                        <a href="`+baseurl+prefix+`/pengumuman/`+semuadata[i].id+`/edit" class="text-dark hover:text-primary edit ms-2">
...
function hps(x) {
  Swal.fire({
    title: "Konfirmasi",
    html: "Ingin menghapus pengumuman <strong class=\'text-danger\'>"+x[1] +"</strong> ?",
    icon: "warning",
...
function doRemove(x) {
    ...
    fetch(baseurl + \'api/pengumuman\', {
        ...
        if(result.code == "200"){
          Swal.fire({
            title: "Ok!",
            html: "Pengumuman <strong class=\'text-danger\'>"+result.data.judul +"</strong> sudah dihapus.",
            icon: "success"
          });
