...
/** source: /home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/admin/berita/edit.latte */
final class Template_030b1403ea extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/Project/kompolnas/website/vendor/abiesoft/Http/../../../templates/admin/berita/edit.latte';
...
';
    ...
    <div class="body-wrapper">
		...
		echo '" onKeyUp="setSlug(this.value)" data-label="Judul" placeholder="Judul berita" />
                                        <label for="judul">Judul</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="viewslug" name="viewslug" value="';
		echo LR\Filters::escapeHtmlAttr($slug) /* line 59 */;
		echo '" placeholder="Slug berita" disabled/>
                                        <input type=\'hidden\' id=\'slug\' name=\'slug\' value="';
		echo LR\Filters::escapeHtmlAttr($slug) /* line 60 */;
		echo '">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                        <textarea class="form-control" style=\'height: 100px;\' id="potongan" name="potongan" data-label="Potongan berita" placeholder="Potongan berita">';
		echo LR\Filters::escapeHtmlText($potongan) /* line 66 */;
		echo '</textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="tag" name="tag" data-label="Tag" placeholder="Tag berita" value="';
		echo LR\Filters::escapeHtmlAttr($tag) /* line 76 */;
		echo '" />
		...
		echo LR\Filters::escapeHtmlAttr($gambar) /* line 92 */;
		echo '">
                                        <img id="preview" src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 93 */;
		echo LR\Filters::escapeHtmlAttr($gambar) /* line 93 */;
		echo '" style="width: 100%; display: block; position: relative; z-index: 1;">
                                    ...
                                    <div class="form-control mt-3" style=\'position: relative; padding: 15px;\'>
                                        <div id=\'urlimage\' style="max-width: 85%; white-space: nowrap; overflow: hidden;">';
		echo LR\Filters::escapeHtmlText($baseurl) /* line 102 */;
		echo LR\Filters::escapeHtmlText($gambar) /* line 102 */;
		echo '</div>
