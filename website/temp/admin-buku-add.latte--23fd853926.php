...
/** source: /home/sukroncrb2025/project/php/kompolnas/vendor/abiesoft/Http/../../../templates/admin/buku/add.latte */
final class Template_23fd853926 extends Latte\Runtime\Template
{
	public const Source = '/home/sukroncrb2025/project/php/kompolnas/vendor/abiesoft/Http/../../../templates/admin/buku/add.latte';
	...
	public function main(array $ʟ_args): void
	{
		...
		$this->renderBlock('js', get_defined_vars()) /* line 151 */;
	}
            ...
            <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-9">
                            <h4 class="fw-semibold mb-8">Buku Baru</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="judul" name="judul" data-label="Judul" placeholder="Judul buku" />
                                        <label for="judul">Judul</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                        <textarea class="form-control" style=\'height: 100px;\' id="keterangan" name="keterangan" data-label="Keterangan buku" placeholder="Potongan buku"></textarea>
                                        <label for="keterangan">Keterangan</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="penulis" name="penulis" data-label="Penulis" placeholder="Penulis buku" />
                                        <label for="penulis">Penulis</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="isbn" name="isbn" data-label="Nomor ISBN" placeholder="Nomor ISBN" />
                                        <label for="isbn">Nomor ISBN</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating mb-3">
                                        <input type="date" class="form-control" id="terbit" name="terbit" data-label="Tanggal terbit" placeholder="Tanggal terbit" />
                                        <label for="terbit">Tanggal terbit</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="penerbit" name="penerbit" data-label="Penerbit" placeholder="Penerbit" />
...
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 155 */;
		echo '/assets/admin/js/forms/select2.init.js"></script>
<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($baseurl)) /* line 156 */;
